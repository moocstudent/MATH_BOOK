...
从**初中数学到大学数学**的中英双语自学网站。把从初中到大学的主干——数与式、方程与不等式、函数与几何、微积分、线性代数、概率统计、离散数学、常微分方程、复变函数、数理统计、最优化——拆成 **11 大模块、44 个章节**;每章含学习目标、知识提纲,以及**登录后解锁**的核心讲义、典型例题与练习。公式用 **KaTeX** 渲染,全站**一键中英切换**,学习进度由 **Firebase** 云端同步。
